...
PLAN_CSV = (
    ...
    "qmt_plan_recent_seasonal_long10_top5.csv"
)
...
def stop(C):
    ...
    with (LOG_DIR / "suspend_log_combo_top5.csv").open("w", encoding="utf-8-sig", newline="") as f:
    ...
    with (LOG_DIR / "delayed_sell_log_combo_top5.csv").open("w", encoding="utf-8-sig", newline="") as f:
